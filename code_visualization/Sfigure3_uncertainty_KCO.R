...
load( file = "results/Rdata/data_visualization/fig2_CIranges_KCO_hpd_interval.RData")
# start <- T
# for (rep_x in 1:100){
...
#       CIs <- hpd_interval(as.numeric(unlist(temp_df[,t])),prob=0.50)
...
# }
#
# save(df, file = "results/Rdata/data_visualization/fig2_CIranges_KCO_hpd_interval.RData")
...
common_par <-c("V_cmax","J_max","R_d","gamma_star", "K_CO") #,"theta_J","alpha_J", "K_C", "K_O"
...
ggsave(filename = paste0("results/Figures/SFig3.png"),width = 7, height = 7)
