...
load(file="results/Rdata/data_visualization/SFig11.RData")

for (scena in 1:2) {
  df_check <- df_final[[scena]]

  levels(df_check$model)[levels(df_check$model) == "vonCaemmerer00"] <- "vonC00"

  df_final[[scena]] <- df_check
}
...
ggsave(filename = paste0("results/Figures/SFig12_model_AIC.png"),width = 7, height = 7)
