...
# }
#
# save(sampled_noisy_params, file="results/Rdata/fig2_sampled_noisy_params.RData")
...
fit_one_repitition <- function(rep_id,rst_models,
  ...
  save(res_list, file=paste0("results/Rdata/fig3_samples/fig3_core_estimate_i",rep_id,".RData"))
}
